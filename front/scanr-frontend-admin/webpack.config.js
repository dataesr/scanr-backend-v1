...
if (process.env.NODE_ENV === 'production') {
    ...
    ///config.devtool = 'source-map'; // [SWORD] source maps not useful in production, else errors in files .styl : ERR_INVALID_ARG_TYPE The "path" argument must be of type string. Received type undefined
