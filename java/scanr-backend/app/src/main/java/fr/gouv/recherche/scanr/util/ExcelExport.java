...
public class ExcelExport {
    ...
    public ExcelExport cell(int index, boolean value) {
        row.createCell(index).setCellValue(value);
        return this;
    }
    ...
    public ExcelExport cell(int index, Float value) {
        if (value != null) {
            row.createCell(index).setCellValue(value);
        }
        return this;
    ...
    public ExcelExport cell(int index, Integer value) {
        if (value != null) {
            row.createCell(index).setCellValue(value);
        }
        return this;
    ...
    public ExcelExport cell(Float value) {
        return cell(cellIndex++, value);
    }

    public ExcelExport cell(Integer value) {
        return cell(cellIndex++, value);
    }
    ...
    public ExcelExport cell(boolean value) {
        return cell(cellIndex++, value);
    }
