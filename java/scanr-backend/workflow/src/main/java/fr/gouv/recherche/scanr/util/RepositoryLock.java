...
public class RepositoryLock<MODEL, KEY extends Serializable, REP extends CrudRepository<MODEL, KEY>> {
    ...
    public class Tx {
         ...
         * @throws fr.gouv.recherche.scanr.api.exception.NotFoundException if the resource is not found
         */
         ...
         *
         * @throws fr.gouv.recherche.scanr.api.exception.NotFoundException if input was empty
         */
