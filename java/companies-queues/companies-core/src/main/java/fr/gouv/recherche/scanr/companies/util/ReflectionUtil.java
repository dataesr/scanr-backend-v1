 ...
 * Apache License 2.0
 */
package fr.gouv.recherche.scanr.companies.util;
...
public class ReflectionUtil {
    ...
    public static <T> Class<T> getParameterizedClass(Object obj) {
        return getParameterizedClass(obj, 0);
    }

    public static <T> Class<T> getParameterizedClass(Object obj, int index) {
        Type[] parameterizedTypes = getParameterizedTypes(obj);
        try {
            return (Class<T>) getClass(parameterizedTypes[index]);
